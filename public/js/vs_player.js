...
socket.on("welcome",(data)=>{
    ...
    if(data.num_users == 1 && data.game.host == localStorage[`${user_data.game_id}_username`]) {
        ...
        player1_losses.innerHTML = data.game.player1_losses
        player1_draws.innerHTML = data.game.player1_draws
        if(data.game.host != localStorage[`${user_data.game_id}_username`] && !localStorage[user_data.game_id]) {
            localStorage[user_data.game_id] = true
            localStorage[`${user_data.game_id}_username`] = data.game.player
            localStorage[`${user_data.game_id}_choice`] = data.game.player_move
            localStorage[`${user_data.game_id}_turn`] = "no"
        ...
        if(localStorage[`${user_data.game_id}_turn`] == "yes") {
            if(document.getElementById("player1_name").innerHTML == localStorage[`${user_data.game_id}_username`]) {
            ...
            if(document.getElementById("player2_name").innerHTML == localStorage[`${user_data.game_id}_username`]) {
                document.getElementsByClassName("player")[1].style.border = "dashed 3px #3bc14a"
            ...
            if(document.getElementById("player2_name").innerHTML.split("<")[0] == localStorage[`${user_data.game_id}_username`]) {
                document.getElementsByClassName("player")[1].style.border = "dashed 3px #A50104"
                document.getElementsByClassName("player")[0].style.border = "dashed 3px #3bc14a"
            }
        }
        ...
        for(let i = 0; i < 9; i++) {
            ...
            if(action != "none") {
                if(action == "cross") {
                    ...
                    document.getElementsByClassName("col")[i].style.backgroundImage = "url('../images/cross_big.png')"
                    document.getElementsByClassName("col")[i].style.backgroundRepeat = "no-repeat"
                    document.getElementsByClassName("col")[i].style.backgroundPosition = "center"
                }
                else if(action == "circle") {
                    boxes[i].style.backgroundColor = "#f3f2da"
                    document.getElementsByClassName("col")[i].style.backgroundImage = "url('../images/circle_big.png')"
                    document.getElementsByClassName("col")[i].style.backgroundRepeat = "no-repeat"
                    document.getElementsByClassName("col")[i].style.backgroundPosition = "center"
                }
            }
...
function show_option(elem,num) {
    if(num_users == 2 && localStorage[`${user_data.game_id}_turn`] == "yes" && localStorage[`${user_data.game_id}_status`] == "ongoing") {
...
socket.on("display_move", async (user_datax) => {
    ...
    if(num_users == 2 && localStorage[`${user_data.game_id}_status`] == "ongoing") {
        if(user_datax.action == "cross") {
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundColor = "#f3f2da"
            localStorage[`${user_datax.game_id}_box${user_datax.num}_status`] = "cross"
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundImage = "url('../images/cross_big.png')"
            ...
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundColor = "#f3f2da"
            localStorage[`${user_datax.game_id}_box${user_datax.num}_status`] = "circle"
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundImage = "url('../images/circle_big.png')"
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundRepeat = "no-repeat"
            document.getElementsByClassName("col")[user_datax.num-1].style.backgroundPosition = "center"
        }
    }
...
async function execute_option(elem,num) {
    if(localStorage[`${user_data.game_id}_turn`] == "no" || localStorage[`${user_data.game_id}_status`] != "ongoing") {
        return false
    }
    ...
    if(num == 1) {
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box2_status`] == action && localStorage[`${user_data.game_id}_box3_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box4_status`] == action && localStorage[`${user_data.game_id}_box7_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 2) {
        if(localStorage[`${user_data.game_id}_box1_status`] == action && localStorage[`${user_data.game_id}_box3_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box8_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 3) {
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box7_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box2_status`] == action && localStorage[`${user_data.game_id}_box1_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box6_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 4) {
        if(localStorage[`${user_data.game_id}_box1_status`] == action && localStorage[`${user_data.game_id}_box7_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box6_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 5) {
        if(localStorage[`${user_data.game_id}_box2_status`] == action && localStorage[`${user_data.game_id}_box8_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box4_status`] == action && localStorage[`${user_data.game_id}_box6_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box3_status`] == action && localStorage[`${user_data.game_id}_box7_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box1_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 6) {
        if(localStorage[`${user_data.game_id}_box3_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box4_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 7) {
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box3_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box4_status`] == action && localStorage[`${user_data.game_id}_box1_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box8_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 8) {
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box2_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box7_status`] == action && localStorage[`${user_data.game_id}_box9_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
    ...
    if(num == 9) {
        if(localStorage[`${user_data.game_id}_box5_status`] == action && localStorage[`${user_data.game_id}_box1_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box8_status`] == action && localStorage[`${user_data.game_id}_box7_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
        ...
        if(localStorage[`${user_data.game_id}_box6_status`] == action && localStorage[`${user_data.game_id}_box3_status`] == action) {
            localStorage[`${user_data.game_id}_status`] = "over"
            socket.emit("move",{ 
                game_id: user_data.game_id,
                action,
